...
<head>
<meta charset="UTF-8">
<title>컨버스 런스타 하이크 하이 블랙 화이트 검</title>
...
<body>
   ...
   <div id="main_frame">
        <div id="main_img">
            <img src="${ pageContext.request.contextPath }/resources/img/women/shoes5.jpg">
        </div>

        <div id="box">
            <div id="subscrip">
                <p>Converse Run Star Hike Hi Black White Gum</p>
                <p id="subtitle">컨버스 런스타 하이크 하이 블랙 화이트 검</p>
                <ul>
                    <li>사이즈</li>
                    <li>
                        <select id="size">
