...
<head>
<meta charset="UTF-8">
<title>컨버스 x 플레이 꼼데가르송 척 70 로우 블랙</title>
...
<body>
   ...
   <div id="main_frame">
        <div id="main_img">
            <img src="${ pageContext.request.contextPath }/resources/img/women/shoes1.jpg">
        </div>

        <div id="box">
            <div id="subscrip">
                <p>Converse x Play Comme des Garcons Chuck 70 Ox Black</p>
                <p id="subtitle">컨버스 x 플레이 꼼데가르송 척 70 로우 블랙</p>
                <ul>
                    <li>사이즈</li>
                    <li>
                        <select id="size">
