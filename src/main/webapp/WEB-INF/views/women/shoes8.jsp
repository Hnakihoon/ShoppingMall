...
<head>
<meta charset="UTF-8">
<title>반스 볼트 OG 올드스쿨 LX 블랙</title>
...
<body>
   ...
   <div id="main_frame">
        <div id="main_img">
            <img src="${ pageContext.request.contextPath }/resources/img/women/shoes8.jpg">
        </div>

        <div id="box">
            <div id="subscrip">
                <p>Vans Vault OG Old Skool LX Black</p>
                <p id="subtitle">반스 볼트 OG 올드스쿨 LX 블랙</p>
                <ul>
                    <li>사이즈</li>
                    <li>
                        <select id="size">
