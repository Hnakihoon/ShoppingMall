...
<head>
<meta charset="UTF-8">
<title>(W) 나이키 덩크 로우 베얼리 그린</title>
...
<body>
   ...
   <div id="main_frame">
        <div id="main_img">
            <img src="${ pageContext.request.contextPath }/resources/img/women/shoes6.jpg">
        </div>

        <div id="box">
            <div id="subscrip">
                <p>(W) Nike Dunk Low Barely Green</p>
                <p id="subtitle">(W) 나이키 덩크 로우 베얼리 그린</p>
                <ul>
                    <li>사이즈</li>
                    <li>
                        <select id="size">
