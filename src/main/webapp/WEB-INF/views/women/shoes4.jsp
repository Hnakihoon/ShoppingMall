...
<body>
   ...
   <div id="main_frame">
        <div id="main_img">
            <img src="${ pageContext.request.contextPath }/resources/img/women/shoes4.jpg">
        </div>

        <div id="box">
            <div id="subscrip">
                <p>(W) Nike Dunk Low Black</p>
                <p id="subtitle">(W) 나이키 덩크 로우 블랙</p>
                <ul>
                    <li>사이즈</li>
                    <li>
                        <select id="size">
