...
<body>
	...
	<div id="main_frame">
        <div id="main_img">
            <img src="${ pageContext.request.contextPath }/resources/img/jordan1midgray.png">
        </div>

        <div id="box">
            <div id="subscrip">
                <p>(W) Jordan 1 Mid Grey Fog</p>
                <p id="subtitle">(W) 조던 1 미드 그레이 포그</p>
                <ul>
                    <li>사이즈</li>
                    <li>
                        <select id="size">
    ...
    <img src="${ pageContext.request.contextPath }/resources/img/jordan_grey1.jpeg"/>
    <img src="${ pageContext.request.contextPath }/resources/img/jordan_grey2.jpeg"/>
