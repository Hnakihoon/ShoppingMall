...
<head>
<meta charset="UTF-8">
<title>나이키 x 피스마이너스원 에어포스 1 로우 파라노이즈</title>
...
<body>
   ...
   <div id="main_frame">
        <div id="main_img">
            <img src="${ pageContext.request.contextPath }/resources/img/men/shoes7.jpg">
        </div>

        <div id="box">
            <div id="subscrip">
                <p>Nike x Peaceminusone Air Force 1 Low Para-Noise</p>
                <p id="subtitle">나이키 x 피스마이너스원 에어포스 1 로우 파라노이즈</p>
                <ul>
                    <li>사이즈</li>
                    <li>
                        <select id="size">
