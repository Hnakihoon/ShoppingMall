...
<head>
<meta charset="UTF-8">
<title>나이키 x 사카이 x 프라그먼트 LD와플 라이트 스모크 그레이</title>

<link rel="stylesheet" type="text/css" href="${ pageContext.request.contextPath }/resources/css/commodity_detail.css">
...
<body>
   ...
   <div id="main_frame">
        <div id="main_img">
            <img src="${ pageContext.request.contextPath }/resources/img/men/shoes3.jpg">
        </div>

        <div id="box">
            <div id="subscrip">
                <p>Nike x Sacai x Fragment LDWaffle Light Smoke Grey</p>
                <p id="subtitle">나이키 x 사카이 x 프라그먼트 LD와플 라이트 스모크 그레이</p>
                <ul>
                    <li>사이즈</li>
                    <li>
                        <select id="size">
