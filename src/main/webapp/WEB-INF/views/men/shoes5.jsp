...
<body>
   ...
   <div id="main_frame">
        <div id="main_img">
            <img src="${ pageContext.request.contextPath }/resources/img/men/shoes5.jpg">
        </div>

        <div id="box">
            <div id="subscrip">
                <p>Jordan 1 Low OG Starfish</p>
                <p id="subtitle">조던 1 로우 OG 스타피쉬</p>
                <ul>
                    <li>사이즈</li>
                    <li>
                        <select id="size">
