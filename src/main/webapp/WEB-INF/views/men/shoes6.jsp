...
<head>
<meta charset="UTF-8">
<title>나이키 에어 맥스 97 트리플 화이트 울프 그레이</title>
...
<body>
   ...
   <div id="main_frame">
        <div id="main_img">
            <img src="${ pageContext.request.contextPath }/resources/img/men/shoes6.jpg">
        </div>

        <div id="box">
            <div id="subscrip">
                <p>Nike Air Max 97 Triple White Wolf Grey</p>
                <p id="subtitle">나이키 에어 맥스 97 트리플 화이트 울프 그레이</p>
                <ul>
                    <li>사이즈</li>
                    <li>
                        <select id="size">
