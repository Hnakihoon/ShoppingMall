...
<head>
<meta charset="UTF-8">
<title>뉴발란스 992 메이드 인 USA 그레이 - D 스탠다드</title>
...
<body>
   ...
   <div id="main_frame">
        <div id="main_img">
            <img src="${ pageContext.request.contextPath }/resources/img/men/shoes1.jpg">
        </div>

        <div id="box">
            <div id="subscrip">
                <p>New Balance 992 Made in USA Grey - D Standard</p>
                <p id="subtitle">뉴발란스 992 메이드 인 USA 그레이 - D 스탠다드</p>
                <ul>
                    <li>사이즈</li>
                    <li>
                        <select id="size">
