...
public class Paging {
	...
	public static String getPaging(String pageURL, int nowPage, int rowTotal, int blockList, int blockPage) {
		...
		//-----그룹페이지처리 이전 --------------------------------------------------------------------------------------------		
		if(isPrevPage){
			sb.append("<a style='text-decoration:none;' href ='"+pageURL+"?page=");
			//sb.append(nowPage - blockPage);
			sb.append( startPage-1 );
			sb.append("'><img src='/project/resources/img/btn_prev.gif'></a>");
		}
		else
			sb.append("<img src='/project/resources/img/btn_prev.gif'>");
		...
		if(isNextPage){
			...
			sb.append(nowPage);*/
			sb.append("'><img src='/project/resources/img/btn_next.gif'></a>");
		}
		else
			sb.append("<img src='/project/resources/img/btn_next.gif'>");
		//---------------------------------------------------------------------------------------------------------------------	    
